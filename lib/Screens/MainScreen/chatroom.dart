                      ...
                      onPressed: () async {
                        if (textController.text.isNotEmpty) {
                          try {
                            ...
                            print(
                                "???????asdwxscsacfhv blajpzu8y7futgcbmasxzuyyifgvjnsaxZyftcgjN<zIYFGCJVzjHOGYFGJCQaZgyg333333333333333333###################################################################################3${widget.receiverId}");
                            textController.clear();
                          } catch (e) {
                            ScaffoldMessenger.of(context).showSnackBar(
                              SnackBar(
                                content: Text(
                                    ">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>jhgfdszdfcgv@@@@@@@#Failed to send message: $e"),
                              ),
                            );
                          }
                        } else {
